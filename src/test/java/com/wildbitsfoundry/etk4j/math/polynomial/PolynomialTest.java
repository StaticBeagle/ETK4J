...
import static com.wildbitsfoundry.etk4j.math.polynomial.Polynomial.polyValFromRoots;
...
public class PolynomialTest {
    ...
    public void testGetRoots() {
        ...
        double[] real = ComplexArrays.real(p1.calculateRoots());
        double[] imag = ComplexArrays.imag(p1.calculateRoots());
        ...
        real = ComplexArrays.real(p1.calculateRoots());
        imag = ComplexArrays.imag(p1.calculateRoots());
        ...
        roots = new Polynomial(8, 6, 7, 5, 3, 0, 9).calculateRoots();
        ...
        roots = new Polynomial(1, 0, 0, 0, 0, 0, 0).calculateRoots();
        ...
        roots = new Polynomial(1, 1, 1, 1, 1, 1, 1).calculateRoots();
        ...
        roots = new Polynomial(1, 0, 0, 0.0, 1).calculateRoots();
        ...
        roots = new Polynomial(2, 2, 1).calculateRoots();
        ...
        roots = new Polynomial(1, 2, 1).calculateRoots();
        re = new double[]{-1, -1};
        im = new double[]{0, 0};
        ...
        roots = new Polynomial(1, 1).calculateRoots();
        re = new double[]{-1};
        im = new double[]{0};
        ...
        roots = new Polynomial(1).calculateRoots();
