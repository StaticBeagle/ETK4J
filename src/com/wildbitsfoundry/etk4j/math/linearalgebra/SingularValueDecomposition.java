...
public class SingularValueDecomposition {
	...
	public Matrix getU() {
		return new Matrix(U, _rows, Math.min(_rows + 1, _cols));
	}
	...
	public Matrix getV() {
		return new Matrix(V, _cols, _cols);
	}
	...
	public double cond() {
		return s[0] / s[Math.min(_rows, _cols) - 1];
	}
