...
//    }
//
//    protected AnalogFilter2(int order, TransferFunction tf) {
//        _order = order;
//        _tf = tf;
//    }
//
...
//    }
//
//    public static AnalogFilter2 newLowPass(LowPassSpecs specs, ApproximationType type) {
...
//        lp._tf.normalize();
//        return new AnalogFilter2(n, lp._tf);
//    }
//
//    public static AnalogFilter2 newHighPass(HighPassSpecs specs, ApproximationType type) {
//        double fp = specs.getPassBandFrequency();
//        double fs = specs.getStopBandFrequency();
//        double ap = specs.getPassBandRipple();
//        double as = specs.getStopBandAttenuation();
...
//    }
//
//    public static AnalogFilter2 newBandPass(BandPassSpecs specs, ApproximationType type) {
...
//        tf.normalize();
//        return new AnalogFilter2(2 * n, tf);
//    }
//
...
//    }
//
//    public static AnalogFilter2 newBandStop(BandStopSpecs specs, ApproximationType type) {
//        double fp1 = specs.getLowerPassBandFrequency();
//        double fp2 = specs.getUpperPassBandFrequency();
//        double fs1 = specs.getLowerStopBandFrequency();
//        double fs2 = specs.getUpperStopBandFrequency();
...
//        wp[0] = goldenSectionMinimizer(AnalogFilter2::bandStopObjMinimize, fp1, fs1 - 1e-12,
//                1e-5, 500, specs, type, 0);
//
//        wp[1] = goldenSectionMinimizer(AnalogFilter2::bandStopObjMinimize, fs2 + 1e-12, fp2,
