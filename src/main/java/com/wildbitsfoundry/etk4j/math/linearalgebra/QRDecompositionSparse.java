...
//        out.nz_length = 0;
	...
	public MatrixSparse getR(MatrixSparse R, boolean compact ) {
		if (R == null)
			R = new MatrixSparse(0, 0, 0);
	 ...
	 * </p>
	 */
	public static void rank1UpdateMultR( MatrixSparse V, int colV, double gamma,
	 ...
	 * @param gw workspace
	 */
	public static void addColAppend( double alpha, MatrixSparse A, int colA, double beta, MatrixSparse B, int colB,
	 ...
	 * @return Dot product
	 */
	public static double dotInnerColumns( MatrixSparse A, int colA, MatrixSparse B, int colB,
										  IGrowArray gw, DGrowArray gx ) {
		if (A.rows != B.rows)
