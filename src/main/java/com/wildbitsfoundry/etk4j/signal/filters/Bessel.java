...
import com.wildbitsfoundry.etk4j.math.optimize.solver.NewtonRaphsonComplex;
...
import static com.wildbitsfoundry.etk4j.signal.filters.Filters.*;
        ...
        for (int i = 0; i < n; ++i) {
            SolverResults<Complex> sr = new NewtonRaphsonComplex(
                    z -> {
                        ...
                        com.wildbitsfoundry.etk4j.math.specialfunction.
